 ...
 *
 * @param autoBootstrap If true, the directive will be automatically bootstrapped on the page immediately after registration. If false, the consumer must call `bootstrapDirectives()` manually to initialize the directive on the page.

    ...
    return html`
      <alwatr-surface elevated>
        ...
        <div class="detail-container">
          <div>
            <span>${message('order_detail_product_name')}:</span>
            <span><b>${product.title.fa}</b></span>
          </div>
          <div>
          ...
          <div>
            ...
            <span>
              <alwatr-text-field type="number" .value=${item.qty.toString()} outlined></alwatr-text-field>
            </span>
          </div>
        </div>
      </alwatr-surface>

...
A secure authentication HOTP token generator (based on the HMAC-based One-Time Password algorithm) and cryptographic utilities, developed within a small TypeScript module.
